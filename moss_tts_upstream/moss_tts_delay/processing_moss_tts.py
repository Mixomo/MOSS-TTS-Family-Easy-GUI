...
class MossTTSDelayProcessor(ProcessorMixin):
    ...
    def encode_audios_from_path(
        ...
        for wav_path in wav_path_list:
            # Avoid Torchaudio 2.9 file I/O, which routes through the optional
            # TorchCodec package. SoundFile/libsndfile provides stable local
            # audio I/O; Torchaudio remains in use for DSP/resampling only.
