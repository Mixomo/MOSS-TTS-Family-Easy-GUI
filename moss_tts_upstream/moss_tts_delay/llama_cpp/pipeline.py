...
class PipelineConfig:
    ...
    def validate(self) -> None:
        ...
        if self.lora_gguf and not Path(self.lora_gguf).expanduser().exists():
            raise FileNotFoundError(f"lora_gguf: {self.lora_gguf} does not exist")
...
class LlamaCppPipeline:
    ...
    def __init__(self, config: PipelineConfig):
        ...
        if self._low_memory:
            ...
            self.backbone = LlamaCppBackbone(
                ...
                lora_path=config.lora_gguf or None,
    ...
    def _load_llm_components(self):
        ...
        backbone = LlamaCppBackbone(
            ...
            lora_path=cfg.lora_gguf or None,
